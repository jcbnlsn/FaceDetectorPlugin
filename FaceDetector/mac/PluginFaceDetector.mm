...
PluginFaceDetector::track( lua_State *L )
{
    ...
    //CIImage* image = [CIImage image imageWithCGImage:source.image.CGImage];
    CIImage* image = [[CIImage alloc] initWithContentsOfFile:[NSString stringWithUTF8String:imagePath]];
    int sourceHeight = image.extent.size.height;
